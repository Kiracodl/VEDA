function final=coupled_VEDA(meshnum,time_steps,Z,Amp,TR,MR,f1,Ham,z_0,nu,E_inf,E_0,tau)
    ...
    Force= ones(1,meshnum)*(radius.*Pressure(h(:,1:time_steps-1),radius))*2*pi*dr;
